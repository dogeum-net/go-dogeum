...
import (
	_ "github.com/dogeum-net/go-dogeum/crypto/secp256k1/libsecp256k1/include"
	_ "github.com/dogeum-net/go-dogeum/crypto/secp256k1/libsecp256k1/src"
	_ "github.com/dogeum-net/go-dogeum/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
