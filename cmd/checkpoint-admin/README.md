...
*For a more detailed introduction to checkpoint, please see the LES [spec](https://github.com/dogeum-net/devp2p/blob/master/caps/les.md).*
...
```shell
go get github.com/dogeum-net/go-dogeum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/dogeum-net/go-dogeum/blob/master/params/config.go#L251).*
